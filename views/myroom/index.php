...
<div class="modal fade create-raspisanie" id="formaCreateRaspisanie" data-toggle="modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <center>
                    <button type="submit" class="btn btn-success" onclick="CreateRaspisanie();">Створити</button>
                        <span id="hash"></span>
...
<script>
    function CreateRaspisanie(hash=null) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'http://localhost/web/api/raspisanie?parametr1=create&parametr2=' + rasp_time_data + '&parametr3=' + rasp_date_data + '&parametr4=' + rasp_number_class_data + '&parametr5=' + rasp_latter_class_data + '&parametr6=' + rasp_predmet_data + '&parametr7=' + rasp_ticher_add_data +'&hash=' +hash, true);
        xhr.onload = function () {
            var obj = JSON.parse(this.responseText);
                            ...
                            <div class="form-group">
                                <a href="#"
                                   ...
                                   onclick="openModalIntervalDateTest();">
                                    ...
                                    <span style="font-size: 19px;">Створитиb</span></a>
